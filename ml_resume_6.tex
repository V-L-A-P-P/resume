...
% Увеличиваем шрифт названий проектов
...
{\href{https://github.com/V-L-A-P-P/Bankruptcy_Prediction_System}{Bankruptcy Prediction System} — production-ready ML-сервис для оценки риска банкротства}{}
...
\resumeProjectHeading
{\href{https://github.com/V-L-A-P-P/AURA}{AURA (Augmented Understanding \& Retrieval for Answers)} — интеллектуальная RAG-система поиска и генерации ответов по финтех-корпусу}{}
...
\resumeProjectHeading
{\href{https://github.com/V-L-A-P-P/Movie_Recommendation_System}{Movie Recommendation System} — ML-модель персональных рекомендаций фильмов}{}
